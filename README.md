...
- **رفع أسرع دائماً**: يُرسل الفيديو على 4 أجزاء في نفس الوقت بدل جزء بعد جزء.
- **ضغط الفيديو قبل الرفع** (خيار في نافذة الرفع، مفعّل افتراضياً): يحوّل الفيديو إلى 720p فيصغر
  فيديو الهاتف عادةً إلى نحو سدس حجمه مع بقائه واضحاً، ويأخذه الخادم كما هو دون إعادة ترميز، فيصبح
  الرفع والتجهيز أسرع. يتم على جهازك قبل الرفع (أبقِ الصفحة مفتوحة أثناء الضغط فقط).
- **بعد الرفع** يظهر «تم الرفع ✓ جاري تجهيز الفيديو للطلاب X%»: التجهيز يتم على الخادم ويمكن إغلاق
  الموقع خلاله.
- **حذف فيديو أو ملف** يُخفيه من القائمة فوراً، مع زر «تراجع» لإعادته.
